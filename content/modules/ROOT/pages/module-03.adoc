...
+
image::301-operatorhub-quay.png[link=self, window=blank, OperatorHub Quay]
+
. Type *Quay* in the search bar, and select the option for *Red Hat Quay*.
+
image::302-install-quay.png[link=self, window=blank, Install Quay]
+
. Click the *Install* button and follow the default prompts.
+
image::303-default-options.png[link=self, window=blank, Quay Default Options]
+
. Once the operator is installed, click on the *Create Instance* button under Quay Registry.
+
image::304-create-quay-instance.png[link=self, window=blank, Create Instance]
+
...
+
image::305-default-install.png[link=self, window=blank, Default Quay Install]
+
. Once it is installed successfully, we can check the *Resources* under the instance.
+
image::306-quay-resources.png[link=self, window=blank, Quay Resources]
...
+
image::310-quay-repos.png[link=self, window=blank, Quay Repositories]
+
...
+
image::311-image-tags.png[link=self, window=blank, Image Tag Menu]
+
...
+
image::312-quay-sec-scan.png[link=self, window=blank, Quay Security Scan]
+
...
+
image::313-security-details.png[link=self, window=blank, Image Security Details] 
+
...
+
image::314-image-packages.png[link=self, window=blank, Image Packages]
+

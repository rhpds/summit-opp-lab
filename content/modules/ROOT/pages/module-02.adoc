...
image::201-lab-environment.png[link=self, Lab Environment]
...
image::202-cert-warning.png[link=self, Certificate Warning]

image::203-login-page.png[link=self, Login Page]
...
image::204-admin-login.png[link=self, Admin Login]

- Ensure you maintain access to the console and keep your tab open for the future lab sections.

image::205-rhacs-dashboard.png[link=self, RHACS Dashboard]
...
image::206-numbered-dashboard.png[link=self, Numbered Dashboard]
...
image::207-top-bar.png[link=self, Top Bar]
...
image::209-search-syntax.png[link=self, Search Syntax]
...
image::210-nav-menu.png[link=self, Navigation Menu]
...
image::211-dashboard-center.png[link=self, Center Dashboard]
...
image::212-three-dashboards.png[link=self, Three Dashboard Sections]
...
image::213-dashboard-filter.png[link=self, Dashboard Filter]

image::214-dashboard-dropdown.png[link=self, Dashboard Drop-down]
...
+
image::215-vuln-dashboard.png[link=self, Vulnerability Management Dashboard]
+
...
+
image::216-top-risky.png[link=self, Riskiest Deployments]
+
...
+
image::217-policy-buttons.png[link=self, Top Policy Buttons]
+
...
+
image::218-riskiest-images.png[link=self, Riskiest Images]
+
...
+
image::219-visa-proc.png[link=self, Visa Processor Image]
+
...
+
image::220-search-bar.png[link=self, Search Bar]
+
You can move on to the next section only when the dashboard displays the image below.
+
image::221-image-info.png[link=self, Image Info]
...
+
image::222-fix-vulns.png[link=self, Fixable Vulnerabilities]
+
- Above the Image Findings section, click on the *Dockerfile* tab:
+
image::223-dockerfile.png[link=self, Dockerfile View]
+
...
+
image::224-riskiest-images2.png[link=self, Riskiest Images]
+
. Search for the log4shell vulnerability using its CVE number (*CVE-2021-44228*)
+
image::225-log4shell-search.png[link=self, log4shell Search]
+
...
+
image::226-risk-panel.png[link=self, Risk Panel]
+
...
+
image::227-log4shell-risk.png[link=self, Log4Shell Risk]
+
. Click on the log4shell deployment and review the risk indicators.
+
image::228-log4shell-info.png[link=self, Log4Shell Info]
+
...
+
image::229-visa-processor.png[link=self, Visa Processor Info]
+
...
+
image::230-policy-mgmt-dashboard.png[link=self, Policy Management Dashboard]
+
. Filter through the policies to find *Ubuntu Package Manager Execution* or use the search bar to select by *category*.
+
image::231-policy-search.png[link=self, Policy Management Search]
+
. Once you have found the policy *Ubuntu Package Manager Execution*, click on it to learn more.
+
image::232-policy-mgmt-details.png[link=self, Policy Management Details]
+
...
+
image::233-network-graph-menu.png[link=self, Network Graph Menu]
+
...
+
image::234-network-namespace.png[link=self, Network Namespace/Deployments]
+
...
+
image::235-backend-atlas.png[link=self, Backend-Atlas Analysis]
...
image::236-add-to-baseline.png[link=self, Add to Baseline]
...
+
image::237-visa-processor-aflows.png[link=self, Visa Processor Anomalous Flows]
+
...
+
image::238-network-policy-generator.png[link=self, Network Policy Generator]
+
. Click the *Generate and simulate network policies* button.
+
image::239-gen-sim-pol.png[link=self, Generate and Simulate Network Policies]
+
. It will generate YAML for applying a new firewall policy based on the current environment.
+
image::240-net-pol-yaml.png[link=self, Network Policy YAML]
...
+
image::241-microservices-demo.png[link=self, Microservices Demo]
+
. From the left, navigate to the *Compliance* page.
. In the upper right, click *SCAN ENVIRONMENT*:
+
image::242-compliance-dashboard.png[link=self, Compliance Dashboard]
+
...
+
image::243-filter-pci-64.png[link=self, Filter Microservices Demo 64%]
+
...
+
image::244-network-pol-sim.png[link=self, Network Policy Simulator]
+
...
+
image::245-filter-pci-79.png[link=self, Filter Microservices Demo 79%]
...
+
image::246-settings-enabled.png[link=self, Verify Settings Enabled]
+
image::247-dynamic-config.png[link=self, Dynamic Configuration]
+
...
+
image::248-image-noscan.png[link=self, Images with No Scans]
+
...
image::248a-violation-log.png[link=self, Violation Log]
...
+
image::249-enforce-runtime.png[link=self, Enforce Runtime Policy]
+
. Click save.
...
+
image::250-violations.png[link=self, Violations Menu]
+
...
image::251-resolve-violation.png[link=self, Resolve Violations]

...
+
image::233-network-graph-menu.png[Network Graph Menu]
+
...
+
image::234-network-namespace.png[Network Namespace/Deployments]
+
...
+
image::235-backend-atlas.png[Backend-Atlas Analysis]
...
image::236-add-to-baseline.png[Add to Baseline]
...
+
image::237-visa-processor-aflows.png[Visa Processor Anomalous Flows]
+
...
+
image::238-network-policy-generator.png[Network Policy Generator]
+
. Click the *Generate and simulate network policies* button.
+
image::239-gen-sim-pol.png[Generate and Simulate Network Policies]
+
. It will generate YAML for applying a new firewall policy based on the current environment.
+
image::240-net-pol-yaml.png[Network Policy YAML]
...
+
image::241-microservices-demo.png[Microservices Demo]
+
. From the left, navigate to the *Compliance* page.
. In the upper right, click *SCAN ENVIRONMENT*:
+
image::242-compliance-dashboard.png[Compliance Dashboard]
+
...
+
image::243-filter-pci-64.png[Filter Microservices Demo 64%]
+
...
+
image::244-network-pol-sim.png[Network Policy Simulator]
+
...
+
image::245-filter-pci-79.png[Filter Microservices Demo 79%]
...
+
image::246-settings-enabled.png[Verify Settings Enabled]
+
image::247-dynamic-config.png[Dynamic Configuration]
+
...
+
image::248-image-noscan.png[Images with No Scans]
+
...
image::248a-inform-action.png[Default Inform Action]
...
+
image::249-enforce-runtime.png[Enforce Runtime Policy]
+
. Click save.
...
+
image::250-violations.png[Violations Menu]
+
...
image::251-resolve-violation.png[Resolve Violations]

...
=== Download the "Wordpress" application and push the container image to Quay via the Bastion VM

IMPORTANT: You will need to complete the following commands in the *Bastion VM* Please SSH to it by using the following command:
...
*Qauy Console Password:* | {quay_admin_password} |
|===

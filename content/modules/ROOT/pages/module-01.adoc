...
image::101-local-cluster.png[link=self, window=blank, Cluster Selection Menu]
...
image::102-cluster-view.png[link=self, window=blank, View of Clusters Listed]
...
image::103-create-cluster.png[link=self, window=blank, Create Cluster]
...
image::104-aws-credentials.png[link=self, window=blank, AWS Credentials]
...
image::105-create-cluster-details.png[link=self, window=blank, Create Cluster Details]
...
image::106-create-cluster-nodepools.png[link=self, window=blank, Create Cluster NodePools]

The next screen allows you to configure networking type to use and it's associated  variables. 

Click on *Next* to proceed.

image::107-create-cluster-networking.png[link=self, window=blank, Create Cluster Networking]
...
image::108-create-cluster-summary-create.png[link=self, window=blank, Create Cluster Summary Page]
...
image::109-view-new-cluster.png[link=self, window=blank, View New Cluster]
...
image::110-labels.png[link=self, window=blank, Cluster Labels]
...
image::111-application-topology.png[link=self, window=blank, Application Topology]
...
image::112-application-route.png[link=self, window=blank, Application Route]
...
image::113-grc-diagram.png[link=self, window=blank, Governance, Risk, Compliance Diagram]
...
image::114-policy-toggle.png[link=self, window=blank, Display the YAML]
...
image::115-enforce-governance-policy.png[link=self, window=blank, Enforce the Governance Policy]
...
image::116-governance-topology.png[link=self, window=blank, Governance Topology]
...
image::117-policies-list.png[link=self, window=blank, Governance Policies List]
...
image::118-policies-enforce-red.png[link=self, window=blank, Enforce the Policy]
...
image::119-policies-enforce-green.png[link=self, window=blank, Policy Enforced]

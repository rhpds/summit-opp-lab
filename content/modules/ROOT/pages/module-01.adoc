...
- To get started, switch over to the OpenShift Console tab.
- Remember that the login is *kubeadmin* and the password is: *dd3aF-yuHGT-janMV-Aq7gr*
- Also, if you want to work with the cluster in the terminal, you will need to perform an 'oc login' command with the login info and token available in the console.

...
sed -i "s|CHANGEME|$QUAY_URL/$QUAY_USER/ctf-web-to-system:0.1|g" $TUTORIAL_HOME/kubernetes-manifests/ctf-web-to-system/ctf-web-to-system.yml
...
backend      api-server                         1/1     1            1           30m
default      api-server                         1/1     1            1           29m
default      ctf-web-to-system                  1/1     1            1           25m
default      frontend                           1/1     1            1           29m
default      juice-shop                         1/1     1            1           30m
default      rce                                1/1     1            1           29m
default      reporting                          1/1     1            1           29m
default      ctf-web-to-system-deployment       1/1     1            1           29m
frontend     asset-cache                        1/1     1            1           29m
medical      reporting                          1/1     1            1           29m
operations   jump-host                          1/1     1            1           29m
payments     visa-processor                     1/1     1            1           29m
```
